//
//  WidgetView_Multi03_L_Comp02_2.swift
...
struct WidgetView_Multi03_L_Comp02_2: View { // enable shadow
    ...
    var body: some View {
        ...
        var dateInt: Int = CustomFunctions().calculateDday(ddayRecievedDate: (ddaySymbolMenu[safe: 1]?.ddayDate ??  "2024.02.10"))
        ...
        .background(Color(hex: ddaySymbolMenu[safe: 0]?.ddayBgColor ?? "ddayNeonPink"))
        .clipped()
    }
}
